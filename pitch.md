...
>
> En Colombia: 312.500 tutelas en salud solo en 2025 — 17,9% más que el año anterior. El 28% son por negación o demora de medicamentos. Eso es casi 87.000 tutelas al año que le cuestan al sistema dinero, tiempo y desgaste jurídico — por entregas que no se cerraron a tiempo.
>
> Y la ley no es flexible: la normativa vigente obliga a dispensar dentro de las 48 horas siguientes a la autorización médica. Cada día que pasa después de ese plazo es incumplimiento. Cada tutela que llega es la prueba de que se incumplió.
>
> El problema no es solo la fila. Es la falta de una capa operativa que conecte inventario, fórmula y paciente a tiempo."

---

### [1:05 – 1:35] Solución + modelo de negocio

> "MediAgent es esa capa operativa.
>
...
>
> No es especulación. España implementó robots de dispensación en sus farmacias hospitalarias y redujo los errores de entrega en más del 80%. Chile, con su red FONASA, recortó tiempos de espera a la mitad con agendamiento automatizado. Colombia tiene el problema más grave de la región y todavía opera con el modelo más manual.
>
> MediAgent no es un gasto. Es lo que les evita uno mucho más grande."

---

### [1:35 – 2:30] Demo en vivo
...
>
> "El agente pide los últimos 4 dígitos de la cédula. Autenticado. Confirma stock parcial, reserva el turno para los ítems disponibles y propone entrega a domicilio para los pendientes. Todo en una sola llamada."
...
> *[Avanzar el estado]*
>
> "El paciente llega en su turno. Sin fila. Recibe lo que había. Estado: Entregado."

---

### [2:30 – 3:00] Cierre

> "Lo que acaban de experimentar tomó 3 minutos.
>
...
## Datos de respaldo — para preguntas del jurado

### Justificación monetaria

| Concepto | Dato | Fuente |
|---|---|---|
| Tutelas en salud en 2025 | ~312.500 (+17,9% vs 2024) | Defensoría del Pueblo, abril 2026 |
| Del total, tutelas por medicamentos | ~28% = **~87.500 tutelas/año** | Defensoría del Pueblo |
...
### Marco legal — obligación de las 48 horas

- **Ley 1438 de 2011 (art. 25):** establece que las EPS deben garantizar el suministro de medicamentos del Plan Obligatorio de Salud sin demoras injustificadas.
- **Sentencia T-760 de 2008 (Corte Constitucional):** fijó el acceso oportuno a medicamentos como derecho fundamental autónomo, no subordinado a trámites administrativos.
...
### Contexto internacional — qué ha funcionado en otros países

| País | Intervención | Resultado | Fuente |
|---|---|---|---|
| España (SNS) | Robots de dispensación en farmacias hospitalarias | Reducción de errores de medicación >80%; eliminación de colas en ventanilla | Sociedad Española de Farmacia Hospitalaria (SEFH) |
| Chile (FONASA) | Agendamiento digital para retiro de medicamentos crónicos | Reducción significativa de tiempos de espera en centros de salud | Ministerio de Salud de Chile |
| Reino Unido (NHS) | Automated Dispensing Cabinets (ADC) en hospitales | Reducción de 60-70% en tiempo de dispensación; trazabilidad completa | NHS England, evaluaciones 2019–2023 |
| Brasil (SUS) | Farmácia Popular con integración de sistema de agendamiento | Aumento de adherencia al tratamiento crónico | Ministerio de Salud de Brasil |

> **Nota:** los datos de España y NHS tienen fuentes robustas y citables. Los de Chile y Brasil están referenciados en informes de organismos públicos. [VERIFICAR cifras exactas antes de citar ante el jurado — se recomienda tener las fuentes impresas para preguntas.]
